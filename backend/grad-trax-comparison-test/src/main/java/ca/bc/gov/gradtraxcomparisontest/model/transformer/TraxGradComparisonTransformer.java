...
import ca.bc.gov.gradtraxcomparisontest.model.config.Program;
import ca.bc.gov.gradtraxcomparisontest.model.dto.TraxGradComparatorDto;
import ca.bc.gov.gradtraxcomparisontest.model.dto.TraxGradComparatorNonGradDto;
import ca.bc.gov.gradtraxcomparisontest.model.dto.grad.algorithm.GradRequirement;
...
public class TraxGradComparisonTransformer {
    ...
    @Autowired
    public TraxGradComparisonTransformer(AppProperties properties) {
